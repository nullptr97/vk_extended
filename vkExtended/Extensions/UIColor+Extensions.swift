...
struct ExtendedColors {
    ...
    static let blue = UIColor.color(from: 0x5090F7) ///UIColor.color(from: 0x0779e4) /// UIColor.color(from: 0x3F8AE0)
...
public extension UIColor {
    class func getThemeableColor(from color: UIColor) -> UIColor {
        if #available(iOS 13, *) {
            return UIColor { (UITraitCollection: UITraitCollection) -> UIColor in
                switch color {
                case .white:
                    return UITraitCollection.userInterfaceStyle == .dark ? ExtendedColors.black : ExtendedColors.white
                case .black:
                    return UITraitCollection.userInterfaceStyle == .dark ? ExtendedColors.white : ExtendedColors.black
                default:
                    return .clear
                }
            }

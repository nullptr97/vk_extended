...
struct SuperAppObject {
    ...
    init(from object: JSON) {
        ...
        self.images = object["count"].array?.map { CoverPhotosURL(from: $0) }
        ...
        self.isLocal = object["isLocal"].bool
    }
}
...
struct ObjectItem {
    ...
    init(from objectItem: JSON) {
        ...
        self.badgeText = objectItem["name"].string
        self.images = objectItem["images"].arrayValue.compactMap { CoverPhotosURL(from: $0) }
        self.title = objectItem["name"].string
        self.appId = objectItem["name"].int
        self.type = objectItem["name"].string
        self.to = objectItem["name"].int
        self.from = objectItem["name"].int
        self.text = objectItem["name"].string
        self.deltaAbsolute = objectItem["name"].double
...
struct MiniApp {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case icon576 = "icon_576"
        case openInExternalBrowser = "open_in_external_browser"
        case icon139 = "icon_139"
        case isInstalled = "is_installed"
        case isVkuiInternal = "is_vkui_internal"
        case isFavorite = "is_favorite"
        case backgroundLoaderColor = "background_loader_color"
        case webviewURL = "webview_url"
        case title
        case areNotificationsEnabled = "are_notifications_enabled"
        case type
        case icon75 = "icon_75"
        case loaderIcon = "loader_icon"
        case icon278 = "icon_278"
        case authorOwnerID = "author_owner_id"
        case icon150 = "icon_150"
        case id
    }

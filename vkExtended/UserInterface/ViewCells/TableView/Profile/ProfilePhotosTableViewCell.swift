...
class ProfilePhotosTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        typeLabel.attributedText = NSAttributedString(string: "Фотографии   ", attributes: [.font: GoogleSansFont.semibold(with: 15), .foregroundColor: UIColor.getThemeableColor(from: .black)])
    ...
    func setupCollection(photos: [PhotoCellViewModel]) {
        ...
        typeLabel.attributedText = NSAttributedString(string: "Фотографии   ", attributes: [.font: GoogleSansFont.semibold(with: 15), .foregroundColor: UIColor.getThemeableColor(from: .black)]) + NSAttributedString(string: "\(photos.count)", attributes: [.font: GoogleSansFont.semibold(with: 12), .foregroundColor: UIColor.adaptableDarkGrayVK])
    }
}

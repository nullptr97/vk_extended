...
public protocol DirectionalEdgeInsetsConvertible {
    ...
    func directionalEdgeInsets(for traitCollection: UITraitCollection?) -> NSDirectionalEdgeInsets
...
extension NSDirectionalEdgeInsets: DirectionalEdgeInsetsConvertible {
    ...
    public func directionalEdgeInsets(for traitCollection: UITraitCollection?) -> NSDirectionalEdgeInsets {
        self
    }

    public func fixedEdgeInsets(for traitCollection: UITraitCollection?) -> UIEdgeInsets {
